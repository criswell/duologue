        ...
        private GameWave GenerateRandomWave(int lastMajorWaveNo, int lastMinorWaveNo)
        {
            ...
            for (int i = 0; i < thisWave.NumEnemies; i++)
            {
                ...
                if(MWMathHelper.IsEven(i))
                    thisWave.Wavelets[thisWave.CurrentWavelet].Enemies[i] = TypesOfPlayObjects.Enemy_Firefly;
                else
                    thisWave.Wavelets[thisWave.CurrentWavelet].Enemies[i] = TypesOfPlayObjects.Enemy_Flambi;
            ...
            //thisWave.Wavelets[thisWave.CurrentWavelet].Enemies[thisWave.NumEnemies - 1] = TypesOfPlayObjects.Enemy_GloopPrince;
            //thisWave.Wavelets[thisWave.CurrentWavelet].StartAngle[thisWave.NumEnemies - 1] = MathHelper.Pi;
            //thisWave.Wavelets[thisWave.CurrentWavelet].StartHitPoints[thisWave.NumEnemies - 1] = 3;
