...
namespace Duologue.Waves
{
    ...
    public class GameWaveManager
    {
        ...
        private GameWave GenerateRandomWave(int lastMajorWaveNo, int lastMinorWaveNo)
        {
            ...
            //else
                thisWave.Wavelets[thisWave.CurrentWavelet].SongID = SongID.SecondChance;
            ...
            thisWave.Wavelets[thisWave.CurrentWavelet].Enemies[thisWave.NumEnemies - 1] = TypesOfPlayObjects.Enemy_Moloch;
