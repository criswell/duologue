...
namespace Duologue.Waves
{
    ...
    public class WaveDefinitions
    {
        ...
        public WaveDefinitions()
        {
            ...
            // First wavelet
            Wavelets[0] = new Wavelet(2, 0, ColorPolarity.Negative);
            ...
            // Second wavelet
            Wavelets[1] = new Wavelet(2, 0, ColorPolarity.Positive);
