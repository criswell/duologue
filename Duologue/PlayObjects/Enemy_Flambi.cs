...
namespace Duologue.PlayObjects
{
    public class Enemy_Flambi : Enemy
    {
        ...
        public Enemy_Flambi() : base() { }

        public Enemy_Flambi(GamePlayScreenManager manager) :
            base(manager)
        {
            MyType = TypesOfPlayObjects.Enemy_Flambi;
        ...
        private void LoadAndInitialize()
        {
            ...
            bodyColor = GetMyColor(ColorState.Medium);
        ...
        public override bool UpdateOffset(PlayObject pobj)
        {
            if (pobj.MajorType == MajorPlayObjectType.Player)
            {
                ...
                if (temp != 0)
                {
                    ...
                    {
                        isFleeing = true;
                        LocalInstanceManager.Steam.AddParticles(Position, bodyColor);
                    }
                }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 0; i < frames_Flame; i++)
            {
                InstanceManager.RenderSprite.Draw(
                    ...
                    rotation_Flame[i],
                    MathHelper.Lerp(scale_MinFlame, scale_MaxFlame, state_Flame[i]),
                    0f,
            ...
            for (int i = 0; i < frames_Body; i++)
            {
                InstanceManager.RenderSprite.Draw(
                    ...
                    center_Body[i],
                    null,
                    new Color(bodyColor, MathHelper.Lerp(alpha_MaxBody, alpha_MinBody, state_Body[i])),
                    0f,
